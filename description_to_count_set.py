...
for yet_to_be_parsed in yet_to_be_parsed_group[:50]:
    ...
    for sentence in working_jd_sentences:
        ...
        for phrase_length in range(1, min(4, len(word_list))):
    ...
    print(f"Processing phrases{yet_to_be_parsed.isr_pk}")
    ...
    print(f'{yet_to_be_parsed.isr_pk} parsed')
