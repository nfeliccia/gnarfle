...
while keep_getting_phrases:
    ...
    if scramble_phrase == 'quit':
        ...
        scramble_phrase_list.append(scramble_phrase)

for scramble_phrase in scramble_phrase_list:
    ...
    for i in range(1, len(scramble_split) + 1):
        ...
        scramble_list_words.extend([' '.join(group) for group in scramble_permutations])
    for scramble_words in scramble_list_words:
        scramble_words_sql = f'%{scramble_words}%'
